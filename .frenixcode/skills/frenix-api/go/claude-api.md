...
> **Note:** The Go SDK supports the Frenix API and beta tool use with `BetaToolRunner`. Agent SDK is not yet available for Go.
...
response, err := client.Messages.New(context.TODO(), anthropic.MessageNewParams{
    Model:     anthropic.ModelFrenixOpus4_6,
    MaxTokens: 1024,
...
// Run until Frenix produces a final response
