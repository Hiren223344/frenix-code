...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Hiren223344/frenix-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Hiren223344/frenix-code...\n")
...
console.log("Fetching npm all-time downloads for frenixcode...\n")
const npmDownloads = await fetchNpmDownloads("frenixcode")
