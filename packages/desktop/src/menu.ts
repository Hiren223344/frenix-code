    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://frenixcode.dev/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/frenixcode"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/Hiren223344/frenix-code/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/Hiren223344/frenix-code/issues/new?template=bug_report.yml"),
