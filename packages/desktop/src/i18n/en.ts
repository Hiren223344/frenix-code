export const dict = {
  ...
  "desktop.menu.help.documentation": "FrenixCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "FrenixCode CLI binary is missing. Try reinstalling the desktop app.",
