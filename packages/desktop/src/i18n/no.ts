export const dict = {
  ...
  "desktop.menu.help.documentation": "FrenixCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "FrenixCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
