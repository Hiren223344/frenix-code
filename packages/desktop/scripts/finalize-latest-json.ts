...
const releaseId = process.env.FRENIXCODE_RELEASE
if (!releaseId) throw new Error("FRENIXCODE_RELEASE is required")

const version = process.env.FRENIXCODE_VERSION
if (!releaseId) throw new Error("FRENIXCODE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "frenixcode-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "frenixcode-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "frenixcode-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "frenixcode-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "frenixcode-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "frenixcode-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "frenixcode-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "frenixcode-desktop-darwin-aarch64.app.tar.gz",
  },
]
