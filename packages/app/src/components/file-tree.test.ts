...
beforeAll(async () => {
  ...
  mock.module("@frenixcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@frenixcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@frenixcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@frenixcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
