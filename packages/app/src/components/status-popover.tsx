...
import { Popover } from "@frenixcode/ui/popover"
import { Switch } from "@frenixcode/ui/switch"
...
export function StatusPopover() {
  ...
  const pluginEmpty = createMemo(() => pluginEmptyMessage(language.t("dialog.plugins.empty"), "frenixcode.json"))
