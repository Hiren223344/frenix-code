import type { Message, Session, TextPart, UserMessage } from "@frenixcode/sdk/v2/client"
import { Avatar } from "@frenixcode/ui/avatar"
import { HoverCard } from "@frenixcode/ui/hover-card"
...
const FRENIXCODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === FRENIXCODE_PROJECT_ID ? "https://frenixcode.dev/favicon.svg" : props.project.icon?.override
          }
