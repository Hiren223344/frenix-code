...
import { ResizeHandle } from "@frenixcode/ui/resize-handle"
import { Button } from "@frenixcode/ui/button"
import { IconButton } from "@frenixcode/ui/icon-button"
import { Tooltip } from "@frenixcode/ui/tooltip"
...
import { Session, type Message } from "@frenixcode/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@frenixcode/ui/toast"
...
import { retry } from "@frenixcode/util/retry"
...
import { useTheme, type ColorScheme } from "@frenixcode/ui/theme"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://frenixcode.dev/desktop-feedback")}
      renderPanel={() =>
        mobile ? (
