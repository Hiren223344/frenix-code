...
export const dict = {
  ...
  "dialog.provider.frenixcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.frenixcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.frenixcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av FrenixCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i FrenixCode.",
  ...
  "provider.connect.frenixcodeZen.line1":
    "FrenixCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.frenixcodeZen.visit.prefix": "Besøk ",
  "provider.connect.frenixcodeZen.visit.link": "frenixcode.dev/zen",
  "provider.connect.frenixcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i FrenixCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i FrenixCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i frenixcode.json",
  ...
  "dialog.server.description": "Bytt hvilken FrenixCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av FrenixCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til FrenixCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (frenixcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at FrenixCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "FrenixCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør FrenixCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for FrenixCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan FrenixCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om FrenixCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan FrenixCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når FrenixCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av FrenixCode.",
