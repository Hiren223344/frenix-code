export const dict = {
  ...
  "dialog.provider.frenixcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.frenixcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.frenixcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje FrenixCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u FrenixCode-u.",
  ...
  "provider.connect.frenixcodeZen.line1":
    "FrenixCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.frenixcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.frenixcodeZen.visit.link": "frenixcode.dev/zen",
  "provider.connect.frenixcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u FrenixCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u FrenixCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u frenixcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se FrenixCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija FrenixCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku FrenixCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (frenixcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: FrenixCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "FrenixCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni FrenixCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u FrenixCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako FrenixCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li FrenixCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu FrenixCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se FrenixCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju FrenixCode-a.",
