export const dict = {
  ...
  "dialog.provider.frenixcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.frenixcode.tagline": "Reliable optimized models",
  "dialog.provider.frenixcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by FrenixCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in FrenixCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in FrenixCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in FrenixCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in frenixcode.json",
  ...
  "dialog.server.description": "Switch which FrenixCode server this app connects to.",
  ...
  "toast.update.description": "A new version of FrenixCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the FrenixCode team",
  ...
  "error.chain.checkConfig": "Check your config (frenixcode.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "FrenixCode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for FrenixCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how FrenixCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether FrenixCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how FrenixCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when FrenixCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of FrenixCode.",
