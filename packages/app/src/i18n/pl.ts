export const dict = {
  ...
  "dialog.provider.frenixcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.frenixcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.frenixcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez FrenixCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w FrenixCode.",
  ...
  "provider.connect.frenixcodeZen.line1":
    "FrenixCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.frenixcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.frenixcodeZen.visit.link": "frenixcode.dev/zen",
  "provider.connect.frenixcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w FrenixCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w FrenixCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w frenixcode.json",
  ...
  "dialog.server.description": "Przełącz serwer FrenixCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja FrenixCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu FrenixCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (frenixcode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, FrenixCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "FrenixCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the FrenixCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla FrenixCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd FrenixCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy FrenixCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw FrenixCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania FrenixCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji FrenixCode.",
