export const dict = {
  ...
  "dialog.provider.frenixcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.frenixcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.frenixcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo FrenixCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no FrenixCode.",
  ...
  "provider.connect.frenixcodeZen.line1":
    "FrenixCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.frenixcodeZen.visit.prefix": "Visite ",
  "provider.connect.frenixcodeZen.visit.link": "frenixcode.dev/zen",
  "provider.connect.frenixcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no FrenixCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no FrenixCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em frenixcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor FrenixCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do FrenixCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do FrenixCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (frenixcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: FrenixCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "FrenixCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor FrenixCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do FrenixCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o FrenixCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o FrenixCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o FrenixCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o FrenixCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do FrenixCode.",
