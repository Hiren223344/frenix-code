...
/**
 * Server configuration for frenixcode serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: frenixcode.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://frenixcode.dev/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://frenixcode.dev/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
