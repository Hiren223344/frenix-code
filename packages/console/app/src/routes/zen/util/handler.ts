...
import { and, Database, eq, isNull, lt, or, sql } from "@frenixcode/console-core/drizzle/index.js"
import { KeyTable } from "@frenixcode/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@frenixcode/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@frenixcode/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@frenixcode/console-core/util/date.js"
import { Identifier } from "@frenixcode/console-core/identifier.js"
import { Billing } from "@frenixcode/console-core/billing.js"
import { Actor } from "@frenixcode/console-core/actor.js"
import { WorkspaceTable } from "@frenixcode/console-core/schema/workspace.sql.js"
import { ZenData } from "@frenixcode/console-core/model.js"
import { Subscription } from "@frenixcode/console-core/subscription.js"
import { BlackData } from "@frenixcode/console-core/black.js"
import { UserTable } from "@frenixcode/console-core/schema/user.sql.js"
import { ModelTable } from "@frenixcode/console-core/schema/model.sql.js"
import { ProviderTable } from "@frenixcode/console-core/schema/provider.sql.js"
...
import { LiteData } from "@frenixcode/console-core/lite.js"
import { Resource } from "@frenixcode/console-resource"
...
export async function handler(
  ...
  const ADMIN_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // frenixcode bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-frenixcode-session") ?? ""
    const requestId = input.request.headers.get("x-frenixcode-request") ?? ""
    const projectId = input.request.headers.get("x-frenixcode-project") ?? ""
    const ocClient = input.request.headers.get("x-frenixcode-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-frenixcode-request")
          headers.delete("x-frenixcode-session")
          headers.delete("x-frenixcode-project")
          headers.delete("x-frenixcode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://frenixcode.dev/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://frenixcode.dev/workspace/${authInfo.workspaceID}/members`
