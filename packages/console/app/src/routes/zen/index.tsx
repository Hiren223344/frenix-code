...
import compareVideo from "../../asset/lander/frenixcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/frenixcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="frenixcode:auth" content={loggedin() ? "true" : "false"} />
