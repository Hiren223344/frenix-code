...
import video from "../asset/lander/frenixcode-min.mp4"
import videoPoster from "../asset/lander/frenixcode-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">frenixcode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">frenixcode/tap/frenixcode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
