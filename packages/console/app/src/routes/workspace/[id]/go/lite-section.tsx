...
import { Database, eq, and, isNull } from "@frenixcode/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@frenixcode/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#frenixcode-go")} target="_blank" rel="noopener noreferrer">
