  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all FrenixCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific FrenixCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new FrenixCode session for interacting with AI assistants and managing conversations.",
