...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/frenixcode.git")).toEqual({ owner: "sst", repo: "frenixcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/frenixcode")).toEqual({ owner: "sst", repo: "frenixcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/frenixcode.git")).toEqual({ owner: "sst", repo: "frenixcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/frenixcode")).toEqual({ owner: "sst", repo: "frenixcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/frenixcode.git")).toEqual({ owner: "sst", repo: "frenixcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/frenixcode")).toEqual({ owner: "sst", repo: "frenixcode" })
})
