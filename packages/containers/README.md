...
```
REGISTRY=ghcr.io/frenixcode TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/frenixcode TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/frenixcode/build/bun-node:24.04
```
