...
const docs = `### Overview
Loads FrenixCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>FrenixCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>FrenixCode Mono Sample</div>
    </div>
  ),
}
