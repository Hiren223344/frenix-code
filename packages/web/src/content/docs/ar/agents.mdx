...
يوجد نوعان من الوكلاء في FrenixCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي FrenixCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي FrenixCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي FrenixCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `frenixcode.json`:
...
- عام: `~/.config/frenixcode/agents/`
- لكل مشروع: `.frenixcode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم FrenixCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات FrenixCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات FrenixCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [FrenixCode Zen](/docs/zen)، فستستخدم `frenixcode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `frenixcode models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/Hiren223344/frenix-code).
:::
