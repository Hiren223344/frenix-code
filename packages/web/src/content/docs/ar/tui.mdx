---
title: TUI
description: استخدام واجهة المستخدم TUI في FrenixCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر FrenixCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل FrenixCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة FrenixCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى FrenixCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من FrenixCode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات FrenixCode.
...
استخدم `FRENIXCODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
