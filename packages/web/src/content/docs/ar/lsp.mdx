---
title: خوادم LSP
description: يتكامل FrenixCode مع خوادم LSP لديك.
---

يتكامل FrenixCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي FrenixCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `FRENIXCODE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح frenixcode ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات frenixcode.
