---
title: Zen
description: Lista curata di modelli fornita da FrenixCode.
---
...
FrenixCode Zen è una lista di modelli testati e verificati dal team di FrenixCode.

:::note
FrenixCode Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in FrenixCode. Accedi a FrenixCode Zen e ottieni la tua chiave API. È **completamente opzionale**: non devi usarlo per usare FrenixCode.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con FrenixCode.
:::
...
FrenixCode Zen e un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

FrenixCode Zen funziona come qualunque altro provider in FrenixCode.

1. Accedi a **<a href={console}>FrenixCode Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona FrenixCode Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di FrenixCode usa il formato `frenixcode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `frenixcode/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su FrenixCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su FrenixCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato FrenixCode Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con FrenixCode.
