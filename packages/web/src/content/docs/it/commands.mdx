...
Crea `.frenixcode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di FrenixCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di FrenixCode:
...
- Globale: `~/.config/frenixcode/commands/`
- Per progetto: `.frenixcode/commands/`
...
frenixcode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
