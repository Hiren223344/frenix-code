---
title: SDK
description: Typesikker JS-klient for FrenixCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

FrenixCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere FrenixCode programmatisk.
...
Opprett en forekomst av FrenixCode:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `frenixcode.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av FrenixCode, kan du opprette en klientforekomst for å koble til den:
