---
title: TUI
description: Bruke frenixcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

FrenixCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre FrenixCode starter TUI for gjeldende katalog.
...
Når du bruker FrenixCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til FrenixCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt FrenixCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `frenixcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `FRENIXCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
