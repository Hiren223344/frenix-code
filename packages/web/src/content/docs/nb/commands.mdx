...
Opprett `.frenixcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom FrenixCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i FrenixCode [config](/docs/config):
...
- Per prosjekt: `.frenixcode/commands/`
...
FrenixCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
