...
Agentferdigheter lar FrenixCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
frenixcode søker etter disse stedene:

- Prosjektkonfigurasjon: `.frenixcode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/frenixcode/skills/<name>/SKILL.md`
...
For prosjektlokale stier går frenixcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.frenixcode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/frenixcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.frenixcode/skills/git-release/SKILL.md` slik:
...
frenixcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `frenixcode.json`:
...
**For innebygde agenter** (i `frenixcode.json`):
