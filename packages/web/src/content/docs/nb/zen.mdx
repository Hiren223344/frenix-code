---
title: Zen
description: Utvalgt liste over modeller levert av FrenixCode.
---
...
FrenixCode Zen er en liste over testede og verifiserte modeller levert av FrenixCode-teamet.

:::note
FrenixCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i FrenixCode. Du logger på FrenixCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med FrenixCode.
:::
...
FrenixCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

FrenixCode Zen fungerer som alle andre leverandører i FrenixCode.

1. Du logger på **<a href={console}>FrenixCode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger FrenixCode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i FrenixCode-konfigurasjonen
bruker formatet `frenixcode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `frenixcode/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på FrenixCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på FrenixCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet FrenixCode Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med FrenixCode også.
