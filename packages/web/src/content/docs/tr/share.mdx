---
title: Paylasim
description: frenixcode konusmalarini genel baglantilarla paylasin.
---

frenixcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda frenixcode:
...
frenixcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak frenixcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `frenixcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda frenixcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
