...
สร้าง `.frenixcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ FrenixCode:
...
- ระดับผู้ใช้ (Global): `~/.config/frenixcode/commands/`
- ระดับโปรเจ็กต์: `.frenixcode/commands/`
...
FrenixCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
