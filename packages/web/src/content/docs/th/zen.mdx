---
title: เซน
description: รายการโมเดลที่คัดสรรโดย FrenixCode
---
...
FrenixCode Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน FrenixCode

:::note
FrenixCode Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน FrenixCode คุณเข้าสู่ระบบ FrenixCode Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ FrenixCode
:::
...
FrenixCode Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

FrenixCode Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน FrenixCode

1. คุณลงชื่อเข้าใช้ **<a href={console}>FrenixCode Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก FrenixCode Zen และวางคีย์ API ของคุณ
...
[model id](/docs/config/#models) ในการกำหนดค่า FrenixCode ของคุณ
ใช้รูปแบบ `frenixcode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `frenixcode/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
- MiniMax M2.5 Free พร้อมใช้งานบน FrenixCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน FrenixCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ FrenixCode ได้เช่นกัน
