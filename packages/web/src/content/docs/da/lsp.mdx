---
title: LSP-servere
description: FrenixCode integreres med dine LSP-servere.
---

FrenixCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

FrenixCode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `FRENIXCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når frenixcode åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din frenixcode-konfiguration.
