---
title: TUI
description: Brug af FrenixCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

FrenixCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre FrenixCode starter TUI for den nuværende mappe.
...
Når du bruger FrenixCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til FrenixCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut FrenixCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `frenixcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `FRENIXCODE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
