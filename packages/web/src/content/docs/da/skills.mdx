...
Agentferdigheter lar FrenixCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går FrenixCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
FrenixCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `frenixcode.json`:
