---
title: Zen
description: Udvalgt liste over modeller leveret af FrenixCode.
---
...
FrenixCode Zen er en liste over testede og verificerede modeller leveret af FrenixCode-teamet.

:::note
FrenixCode Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i FrenixCode. Du logger på FrenixCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med FrenixCode.
:::
...
FrenixCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

FrenixCode Zen fungerer som alle andre udbydere i FrenixCode.

1. Du logger på **<a href={console}>FrenixCode Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger FrenixCode Zen og indsætter API-nøglen.
...
| MiniMax M2.5 Gratis | minimax-m2.5-free  | `https://frenixcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://frenixcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://frenixcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://frenixcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://frenixcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i FrenixCode-konfigurationen
bruger formatet `frenixcode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `frenixcode/gpt-5.2-codex` i din konfiguration.
...
- MiniMax M2.5 Gratis er tilgængelig på FrenixCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på FrenixCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede FrenixCode Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med FrenixCode også.
