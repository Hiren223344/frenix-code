...
Brug den til at bygge integrasjoner og kontrollere frenixcode programmatisk.
...
Opret en forekomst av frenixcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `frenixcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av frenixcode, kan du oprete en klientforekomst for at koble til den:
