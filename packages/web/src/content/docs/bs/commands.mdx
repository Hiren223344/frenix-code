...
Kreiraj `.frenixcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz FrenixCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom FrenixCode [config](/docs/config):
...
- Globalno: `~/.config/frenixcode/commands/`
- Po projektu: `.frenixcode/commands/`
...
FrenixCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
