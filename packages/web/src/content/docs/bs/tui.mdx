---
title: TUI
description: Korištenje korisničkog interfejsa FrenixCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

FrenixCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje FrenixCode pokreće TUI za trenutni direktorij.
...
Kada koristite FrenixCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u FrenixCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz FrenixCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `frenixcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `FRENIXCODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
