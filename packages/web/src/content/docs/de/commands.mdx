...
Erstellen Sie `.frenixcode/commands/test.md`:

```md title=".frenixcode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die FrenixCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem FrenixCode [config](/docs/config):

```json title="frenixcode.jsonc" {4-12}
{
...
- Global: `~/.config/frenixcode/commands/`
- Pro Projekt: `.frenixcode/commands/`

```markdown title="~/.config/frenixcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".frenixcode/commands/component.md"
---
...
```md title=".frenixcode/commands/create-file.md"
---
...
```md title=".frenixcode/commands/analyze-coverage.md"
---
...
```md title=".frenixcode/commands/review-changes.md"
---
...
```md title=".frenixcode/commands/review-component.md"
---
...
FrenixCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
