---
title: Teilen
description: Teile FrenixCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu FrenixCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht FrenixCode Folgendes:
...
FrenixCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt FrenixCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`frenixcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du frenixcode in deiner Organisation einsetzt.
