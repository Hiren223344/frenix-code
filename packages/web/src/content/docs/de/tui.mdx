---
title: TUI
description: Arbeite mit FrenixCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

FrenixCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet FrenixCode die TUI im aktuellen Verzeichnis.
...
In der FrenixCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu FrenixCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet FrenixCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `frenixcode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `FRENIXCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
