---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala frenixcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

frenixcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie frenixcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI frenixcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do frenixcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij frenixcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `frenixcode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `FRENIXCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
