---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące frenixcode.
---

Funkcja udostępniania frenixcode umożliwia tworzenie publicznych linków do konwersacji frenixcode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, frenixcode:
...
frenixcode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie frenixcode korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `frenixcode.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu frenixcode w Twojej organizacji.
