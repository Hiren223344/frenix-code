---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez FrenixCode.
---
...
FrenixCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół FrenixCode.

:::note
FrenixCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w FrenixCode. Logujesz się do FrenixCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z FrenixCode.
:::
...
FrenixCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

FrenixCode Zen działa jak każdy inny dostawca w FrenixCode.

1. Logujesz się do **<a href={console}>FrenixCode Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz FrenixCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji FrenixCode
używa formatu `frenixcode/<model-id>`. Na przykład w przypadku GPT 5.2 Codex użyłbyś
`frenixcode/gpt-5.2-codex` w swojej konfiguracji.
...
- MiniMax M2.5 Free jest dostępny w FrenixCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w FrenixCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy FrenixCode Zen, aby:
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w FrenixCode.
