...
Utwórz `.frenixcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `frenixcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji frenixcode:
...
- Globalnie: `~/.config/frenixcode/commands/`
- Na projekt: `.frenixcode/commands/`
...
frenixcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
