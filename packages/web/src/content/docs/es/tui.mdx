---
title: TUI
description: Usando la interfaz de usuario del terminal FrenixCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

FrenixCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar FrenixCode se inicia TUI para el directorio actual.
...
Cuando utilice FrenixCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a FrenixCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de FrenixCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `frenixcode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `FRENIXCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
