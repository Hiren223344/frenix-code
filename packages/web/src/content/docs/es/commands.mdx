...
Crear `.frenixcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración FrenixCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su FrenixCode [config](/docs/config):
...
- Por proyecto: `.frenixcode/commands/`
...
frenixcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
