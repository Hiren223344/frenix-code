---
title: Zen
description: Lista seleccionada de modelos proporcionada por FrenixCode.
---
...
FrenixCode Zen es una lista de modelos probados y verificados proporcionada por el equipo FrenixCode.

:::note
FrenixCode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en FrenixCode. Inicias sesion en FrenixCode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar FrenixCode.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con FrenixCode.
:::
...
FrenixCode Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

FrenixCode Zen funciona como cualquier otro proveedor en FrenixCode.

1. Inicias sesión en **<a href={console}>FrenixCode Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona FrenixCode Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de FrenixCode
usa el formato `frenixcode/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `frenixcode/gpt-5.2-codex` en tu configuracion.
...
- MiniMax M2.5 Free está disponible en FrenixCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en FrenixCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con FrenixCode también.
