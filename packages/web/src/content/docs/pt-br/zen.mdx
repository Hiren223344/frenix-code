---
title: Zen
description: Lista selecionada de modelos fornecidos pelo FrenixCode.
---
...
O FrenixCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do FrenixCode.

:::note
O FrenixCode Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no FrenixCode. Você faz login no FrenixCode Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o FrenixCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o FrenixCode.
:::
...
O FrenixCode Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O FrenixCode Zen funciona como qualquer outro provedor no FrenixCode.

1. Você faz login no **<a href={console}>FrenixCode Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona FrenixCode Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do FrenixCode usa o formato `frenixcode/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `frenixcode/gpt-5.2-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no FrenixCode por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no FrenixCode por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o FrenixCode também.
