---
title: TUI
description: Usando a interface de usuário de terminal frenixcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O frenixcode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar frenixcode inicia o TUI para o diretório atual.
...
Ao usar o TUI do frenixcode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao frenixcode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do frenixcode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `frenixcode.json`, que configura o comportamento do servidor/runtime.
...
Use `FRENIXCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
