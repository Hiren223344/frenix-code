---
title: Share
description: Share your FrenixCode conversations.
---

FrenixCode's share feature allows you to create public links to your FrenixCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, FrenixCode:
...
FrenixCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, FrenixCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `frenixcode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using frenixcode in your organization.
